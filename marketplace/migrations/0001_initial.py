    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(blank=True, help_text='Choose an emoji icon for this category', max_length=50, null=True)),
                ('color', models.CharField(blank=True, help_text='Emoji color (optional)', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejected_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rejected_items', to=settings.AUTH_USER_MODEL)),
