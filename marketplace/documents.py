...
# -----------------------------------------------------
# ✅ If NOT on Render → define Elasticsearch document
# -----------------------------------------------------
if not IS_RENDER:
    # -----------------------------------
    # Index config
    ...
    # -----------------------------------------------------
    # 🚫 On Render → disable Elasticsearch completely
    # -----------------------------------------------------
    from django_elasticsearch_dsl.registries import registry
    registry._active = False

    # Dummy class so imports like `from .documents import ItemDocument`
